<template>
  <section :class="{'section' : true, 'backColorBlue': backgroundBlue }">
    <v-row v-if="topline !== undefined"  align="center" justify="center" class="secRow" no-gutters>
      <v-col cols="12">
        <div class="titleFont">
          {{ topline }}
        </div>
      ...
      <v-col cols="12">
        <div class="ma-sm-12 ma-0 ">
         ...
         <div v-if="imageUrl === undefined">
          <div v-if="!videoUrl.endsWith('.mp4')" class="iframe-container ma-sm-12 ma-0">
            <iframe 
              v-if="videoUrl"
    ...
    <v-row  align="left" justify="center" class="secRow" no-gutters>
      <v-col cols="6" sm="10" md="10" lg="10" xl="10" >
          ...
          >{{title}} </h1>
          <div v-if="bullets !== undefined" class="columnList colorDark mt-3 mb-3">
            <ul>
              <li  
          ...
          <p v-if="subtitle !== undefined" class="text-left subTitleFont colorDark2 mb-10">
            {{subtitle}}
          </p>
          <v-row class="justify-start mb-12" no-gutters>
            <v-btn
              ...
              class="normalCaps buttonStd mr-12 mb-2"
              :href="button1Link"
            >
              {{button1Text}}
            </v-btn>
            <v-btn
              ...
              class="normalCaps buttonStd mb-2"
              :href="button2Link"
            >
              {{button2Text}}
            </v-btn>
